...
try:
    ...
    LIFE_TIME = 10.0
    debug.draw_box(carla.BoundingBox(carla.Location(x=vehicle.get_location().x+bound_x,y=vehicle.get_location().y+bound_y,z=vehicle.get_location().z+bound_z),vehicle.bounding_box.extent),spawn_point.rotation,life_time=LIFE_TIME)
    LENGTH = 200
    OFFSET = LENGTH * np.sin(0.25*np.pi/180)
    print()
    debug.draw_line(carla.Location(x=13.0+OFFSET, y=-169+LENGTH, z=0.3),
                    carla.Location(x=13.0, y=-169, z=0.3),life_time = LIFE_TIME)
    debug.draw_line(carla.Location(x=9.6+OFFSET, y=-169+LENGTH, z=0.3),
                    carla.Location(x=9.6, y=-169, z=0.3),life_time = LIFE_TIME)
    debug.draw_line(carla.Location(x=14.75+OFFSET, y=-169+LENGTH, z=0.3),
                    carla.Location(x=14.75, y=-169, z=0.3),life_time = LIFE_TIME)
    debug.draw_line(carla.Location(x=16.5+OFFSET, y=-169+LENGTH, z=0.3),
                    carla.Location(x=16.5, y=-169, z=0.3),life_time = LIFE_TIME)
    debug.draw_line(carla.Location(x=13.0, y=-172.5, z=0.3), #172.5
                    carla.Location(x=16.5, y=-168.4, z=0.3),life_time = LIFE_TIME)
    debug.draw_point(carla.Location(x=14.75, y=-169, z=0.3), color = carla.Color(0,0,255), life_time = 10.0)
